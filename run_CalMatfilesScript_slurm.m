...
OW=1; %set Overwriting to 1 if you want to overwrite existing output files

input_dir=pwd;
Subjects = dir(input_dir);
cmd = 'Voice_selectivity_ConfusionMatrix(''%s'');';
ExistingFiles=0;
...
%     if strcmp(Indiv, 'GreBlu9508M')
        ...
        outputmatfiles=dir(fullfile(Idir,'ConfVoi_*.mat'));
