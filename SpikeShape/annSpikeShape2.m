...
load meanSnipsAllSolveig     % Loads the mat file that was made with getMeanSnipsSS.m
...
for i=1:nAnn
    ...
    snipType = input('Type in the snippet Type n (narrow), w (wide), l (large), d (double)', 's');
    while ~(strcmp(snipType, 'n') || strcmp(snipType, 'w') || strcmp(snipType, 'l') || strcmp(snipType, 'd') )
...
save meanSnipsAllSolveigAnn allMeanSnips G5Snips typeSnips indPlot nAnn
